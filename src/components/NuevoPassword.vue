    ...
    <div class="container" style="width: 500px;">
        ...
        <div class="row justify-content-center">
            <div class="col" style="margin: 0 auto;">
                <input class="form-control" type="email" name="" id="" style="font-family: 'OpenSans-Bold';" placeholder="Nueva contraseña">
            </div>
        </div>
        <br><br>
        <div class="row justify-content-center">
            <div class="col" style="margin: 0 auto;">
                <input class="form-control" type="email" name="" id="" style="font-family: 'OpenSans-Bold';" placeholder="Confirmar nueva contraseña">
            </div>
        </div>
        <br><br>
        <div class="row"> 
            <div class="col" style="  display: flex; justify-content: center; align-items: center;">
                <button class="btnEnvioCorreo rounded" type="submit">Cambiar contraseña</button>
            </div>
        </div>
