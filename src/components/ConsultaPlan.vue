  ...
  <div class="container">
    <div class="container" id="element-to-converte">
      ...
      <div class="row filaPlanTabla">
        <div class="col-12 col-md-12 col-sm-12 text-center">
          <img
            src="../assets/img/mobile/Recurso 23x.png"
            class="imgNaranjinPlan"
            alt="..."
          />
        </div>
      </div>
      ...
      <div class="container contenedorMovil">
        <div class="row">
          <div class="col-10">
            <div
              class="container border border-secondary border-1 border-end-0"
            >
              <div class="row">
          ...
          <div
            class="col-2 col-md-4 col-sm-3 border"
            style="
              display: flex;
              flex-direction: row;
          ...
          >
            ...
            <div
              ...
              id="exampleModalDos"
              tabindex="-1"
              aria-labelledby="exampleModalLabelDos"
              aria-hidden="true"
            >
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body" style="border: none">
                    <h1
                      class="modal-title tituloModal"
                      id="exampleModalLabelUno"
                    >
                    ...
                    >
                      ...
                      <div class="mb-3">
                        <label
                          for=""
                          class="form-label labelModalEditarFechaEstu"
                          >Fecha de estudio</label
                        >
                        ...
                        <div class="input-group">
                          <input
                            type="date"
                            class="form-control inputLabelFechaModalEditarPlan"
                      ...
                      <div class="mb-3">
                        <label
                          for="exampleInputPassword1 labelModalEditarHoraColonos"
                          class="form-label"
                          >Hora de la colonoscopia o estudio</label
                        >
                        ...
                        <span
                          class="error"
                          style="color: red"
                          v-if="errors2.horaIngresada"
                          >{{ errors2.horaIngresada }}</span
                        >
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"
                          >Fecha de la primera toma de Picoprep</label
                        >
                      ...
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"
                          >Hora de la primera toma de Picoprep</label
                        >
                        <!-- <input type="time" class="form-control" id="exampleInputPassword1" placeholder="18:00 Hrs"> -->
                        <div class="input-group">
                          <input
                      ...
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"
                          >Fecha de la segunda toma de Picoprep</label
                        >
                        <!-- <input type="date" class="form-control" id="exampleInputPassword1" placeholder="23/11/2022"> -->
                        <div class="input-group">
                          <input
                      ...
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"
                          >Hora de la segunda toma de Picoprep</label
                        >
      ...
      <div class="row fila tamanyo">
        ...
        <div
          class="col-3 col-md-2 col-sm-3 columnaTabla"
        ...
        <div
          class="col-3 col-md-2 col-sm-5 columnaTabla"
          style="border: 1px solid #ff9900"
        >
          <div class="card mb-3" style="border: none">
            <div class="row">
    ...
    aria-describedby="emailHelp"> -->
      ...
      <div class="row">
        <div class="col-1 col-md-3 col-sm-5 text-center columnaUno">
          <img
            src="../assets/img/web/681332-300-300 1_2.png"
            alt="..."
            width=""
          />
        </div>
        ...
        <div class="col-1 col-md-3 col-sm-3 text-center columnaUno">
          <img
            src="../assets/img/web/vaso-de-agua (2).png"
            class="imgVasoAgua"
            alt="..."
            width=""
          />
      ...
      <div class="row">
        <div class="col align-self-center">
          ...
          <div class="">
            ...
            <button
              type="button"
              class="btnVerReferenciaMedica rounded"
              data-bs-toggle="modal"
            ...
            <div
              ...
              id="exampleModalVer"
              tabindex="-1"
              aria-labelledby="exampleModalLabelVer"
              aria-hidden="true"
            >
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
...
Clave IPP:
          ...
          <div class="col-7 col-md-4 col-sm-12">
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col">
                  <a
                    href=""
                    data-bs-target="#exampleModalQuiero"
                    style="cursor: pointer"
                  >
                    <img src="../assets/img/web/campana-web.png" alt="" /><span
                      class="m-3"
                      ><p>Quiero dejar de recibir notificaciones</p> por Whatsapp</span
                    >
                  </a>
                </div>
              </div>
            ...
            <div
              class="modal fade"
              id="exampleModalQuiero"
              tabindex="-1"
              aria-labelledby="exampleModalLabelQuiero"
              aria-hidden="true"
            >
                  ...
                  <div class="modal-body" style="border: none">
                    <div class="col">
                      <p class="parrafoEstasSeguro text-center">
                        ¿Está seguro que quieres dejar de recibir
                        notificaciones?
                      </p>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    validarHora: function (event) {
      ...
      if (
        !this.inputLadaEnabled ||
        !this.inputTelPerfilEnabled ||
        !this.selectEstadoEnabled ||
        !this.inputCiudadEnabled ||
        !this.inputEdadEnabled ||
        !this.inputNomMedTratEnabled ||
        !this.inputApeMedTratEnabled ||
        !this.inputClaveAccesoEnabled
      ) {
        return;
      } else {
