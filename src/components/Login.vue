            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-sm-6 col-md-6 text-center">
                        <img src="../assets/img/web/Enmascarar grupo 2.png" class="imgNaranjin" alt="no hay imagen">
                    </div>
                    <div class="col-xl-6 col-sm-6 col-md-6">
                                                        ...
                                                        <form @submit.prevent="submitFormCrearPlan()">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <input type="text" class="form-control" name="telefono"
                                                                        id="telefonoCel" placeholder="Teléfono celular"
                                                                ...
                                                                <div class="col-7">
                                                                    <div class="row ms-1">
                                                                        ...
                                                                        <div class="col-6 col-md-5">
                                                                            ...
                                                                            <span class="correct" style="color: green;"
                                                                                v-if="correct.edad">{{
                                                                                    correct.edad
                                                                                }}</span>
                                                                        </div>
                                                            ...
                                                            <div class="col">
                                                                <p class="parrafoRecordaViaWhat">Para recibir
                                                                    ...
                                                                    autorizar la recepción de los recordatorios por
                                                                    este
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label parrafoCheckLeido">He
                                                                    leído y
                                                                    acepto
                                                                    el <a style="cursor: pointer;" class="textoSwitchAcepto"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#exampleModal">aviso de
                                                                        privacidad</a>
                                                                        ...
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header"
                                                                                    style="border: none;">
                                                                                    <div class="contenidoCentrado">
                                                                                        <h1 class="tituloPrincipal text-center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aviso de Privacidad
                                                                                                </h1>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <p
                                                                                                    ...
                                                                                                    Tratamiento de la
                                                                                                    Información.</p>
                                                                                                <p class=""><b>Aviso de Privacidad</b> 
                                                                                                </p>
                                                                                                <p
                                                                                                    class="parraffoJustificado">
                                                                                                ...
                                                                                                <p
                                                                                                    ...
                                                                                                    procesa sus datos
                                                                                                    personales y
                                                                                                    describirá la manera en
                                                                                                    la cual nos
                                                                                                    aseguramos de que sus
                                                                                                    datos
                                                                                                    personales se vean
                                                                                                    protegidos de
                                                                                                    acuerdo con las
                                                                                                ...
                                                                                                <p
                                                                                                    ...
                                                                                                    solamente se
                                                                                                    vincula con
                                                                                                    este sitio web; por lo
                                                                                                    tanto, si
                                                                                                    visita otro sitio web
                                                                                                    relacionado o
                                                                                                    recomendado por Ferring
                                                                                                    consulte el
                                                                                                    aviso de privacidad del
                                                                                                    sitio web
                                                                                                    respectivo.</p>
                                                                                                <p>¿Qué son los datos
                                                                                                    personales?</p>
                                                                                                <p>¿Quién puede considerarse
                                                                                                    un
                                                                                                    interesado?</p>
                                                                                                <p>¿Cómo utiliza Ferring sus
                                                                                                    datos
                                                                                                    personales?</p>
                                                                                                <p>Cookies</p>
                                                                                                <p>Retención de datos
                                                                                                    personales </p>
                                                                                                <p>Sus derechos </p>
                                                                                                <p>¿Cómo puede Ferring
                                                                                                    compartir o
                                                                                                    transferir sus datos
                                                                                                    personales?</p>
                                                                                                <p>Vínculos con otros sitios
                                                                                                    web</p>
                                                                                                ...
                                                                                                <p
                                                                                                    ...
                                                                                                    con un individuo que lo
                                                                                                    identifica o
                                                                                                    lo hace identificable.
                                                                                                    Entre estos
                                                                                                    se
                                                                                                    encuentra: nombre,
                                                                                                    domicilio, número
                                                                                                ...
                                                                                                <p
                                                                                                    ...
                                                                                                    identificado o
                                                                                                    identificable sobre
                                                                                                    quien son procesados
                                                                                                    los datos personales. Si
                                                                                                    usted no es
                                                                                                    un interesado de Ferring
                                                                                                    tiene la
                                                                                                    oportunidad de serlo al
                                                                                                    visitar este
                                                                                                    sitio web y proporcionar
                                                                                                    sus datos
                                                                                                    personales de manera
                                                                                                    voluntaria y
                                                                                                    así volverse un
                                                                                                    interesado. Ferring
                                                                                                    solamente reunirá sus
                                                                                                    datos
                                                                                                    personales durante su
                                                                                                    visita en el
                                                                                                    sitio web en
                                                                                                    caso de y cuando los
                                                                                                    proporcione
                                                                                                    voluntariamente.</p>
                                                                                                <hr>
                                                                                                <p>Categorías de datos
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <li>
                                                                                                        Los datos personales
                                                                                                        pueden ser recabados
                                                                                                        y procesados durante
                                                                                                        nuestras
                                                                                                        actividades
                                                                                                        comerciales y
                                                                                                        educativas con usted
                                                                                                        como Profesional
                                                                                                        Sanitario.
                                                                                                        Refiérase a nuestro
                                                                                                        Aviso de Privacidad
                                                                                                    ...
                                                                                                    E. ingresar la
                                                                                                    información que ha
                                                                                                    proporcionado en un base
                                                                                                    de datos. Que
                                                                                                    esta información no se
                                                                                                    mantendrá confidencial.
                                                                                                    Se mostrará en uno o más
                                                                                                    sitios web controlados
                                                                                                    por Ferring, como parte
                                                                                                    del buscador de clínicas
                                                                                                    para
                                                                                                    pacientes que
                                                                                                    ...
                                                                                                    <p>A. Enviar información
                                                                                                        sobre cambios en las
                                                                                                        condiciones de los
                                                                                                        Productos
                                                                                                        ofrecidos por
                                                                                                        FERRING.</p>
                                                                                                    <p>B. Tratar los datos
                                                                                                        de los clientes y
                                                                                                        usuarios de
                                                                                                        FERRING.
                                                                                                        suministrados por
                                                                                                    ...
                                                                                                    K. En los casos en que
                                                                                                    resulte necesario, como,
                                                                                                    ...
                                                                                                    autoridades
                                                                                                    competentes, entre ellas
                                                                                                    solicitar acudir a
                                                                                                    atención médica e
                                                                                                    implementar un
                                                                                                    protocolo de
                                                                                                    confinamiento, según sea
                                                                                                    aplicable.
                                                                                                    <p>
                                                                                                        L. Con motivo de
                                                                                                        alguna emergencia
                                                                                                    ...
                                                                                                    <p>
                                                                                                        ...
                                                                                                        de Contacto del
                                                                                                        Interesado –
                                                                                                        <a href="https://ferring.ethicspoint.eu/custom/ferring/forms/data/form_data.asp"
                                                                                                            target="_blank"
                                                                                                    ...
                                                                                                    <p>
                                                                                                        ...
                                                                                                        o
                                                                                                        agentes), con las
                                                                                                        bases legitimas para
                                                                                                        dicha transferencia,
                                                                                                        como puede ser
                                                                                                        una razón comercial
                                                                                                        válida. Dichas
                                                                                                        ubicaciones pueden
                                                                                                        incluir países fuera
                                                                                                        del Espacio
                                                                                                        Económico Europeo
                                                                                                        (EEE). Y cualquier
                                                                                                        transferencia será
                                                                                                    ...
                                                                                                    <p>Ferring de ningún
                                                                                                        modo venderá su
                                                                                                        información a ningún
                                                                                                        tercero.</p>

                                                                                                    <p>Vínculos con otros
                                                                                                        sitios web</p>
                                                                                                    ...
                                                                                                    <p>
                                                                                                        ...
                                                                                                        Contacto
                                                                                                        del Interesado –
                                                                                                        <a href="http://https://ferring.ethicspoint.eu/custom/ferring/forms/data/"
                                                                                                            target="_blank"
                                                                                                    ...
                                                                                                    <p>Como alternativa
                                                                                                        ...
                                                                                                        la siguiente
                                                                                                        dirección:</p>
                                                                                                    <p>(Atención: Oficial de
                                                                                                        Protección de Datos)
                                                                                                    </p>
                                                                                                    <p>Ferring International
                                                                                                        Center S.A.</p>
                                                                                                    <p>Chemin De la
                                                                                                        Vergognausaz 50</p>
                                                                                                    <p>1162 St Prex</p>
                                                                                                    ...
                                                                                                    <p>Ferring International
                                                                                                        PharmaScience Center
                                                                                                        (IPC)</p>
                                                                                                    <p>Amager Strandvej 405
                                                                                                    </p>
                                                                                                    <p>2770 Kastrup</p>
                                                                                                    <p>Denmark (Dinamarca)
                                                                                                    </p>
                                                                                    ...
                                                                                    <div class="container">
                                                                                        <div class="row">
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    class="contenidoCentrado">
                                                                                                    <button
                                                                                                        class="btnCerrarAviso  rounded" data-bs-dismiss="modal">CERRAR</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
    ...
    methods: {
        ...
        validarTelefonoCelular() {
            ...
            if (!this.telefonoCelular) {
                ...
                this.errors.telefonoCelular = 'El teléfono celular solo debe contener números';
                valida = false;
            } else if (this.telefonoCelular.length < 7) {
                this.errors.telefonoCelular = 'El teléfono celular no debe ser menor a 7 números';
                valida = false;
            } else if (this.telefonoCelular.length > 10) {
                this.errors.telefonoCelular = 'El teléfono celular no debe exceder 10 números';
                valida = false;
            } else {
