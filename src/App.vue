<template>
    <div id="app">
        <!-- <nav class="navbar navbar-expand-lg bg-light shadow">
            <router-link to="/" class="navbar-brand tituloNav">Intestino Limpio</router-link> |
            <router-link to="/crear">Crear nuevo plan de tomas</router-link> |
            <router-link to="/consulta">Intestino Limpio</router-link> |
